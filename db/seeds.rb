...
# Layouts
def create_layout content_type, name, html_content, num_panels=nil
...
create_layout "PAGE", "1 - Full", '<div class="panel_wrapper full">@panel_1</div>', 1
...
create_layout "PANEL", "Half Combo (Image Left)", '<div id="@id" class="panel half-text split @classes"><div class="split-left"><div class="image_container">@images</div></div><div class="split-right">@text</div></div>'
create_layout "PANEL", "Half Combo (Image Right)", '<div id="@id" class="panel half-text split @classes"><div class="split-left">@text</div><div class="split-right"><div class="image_container">@images</div></div></div>'
# create_layout "PANEL", "Vertical Text", ''
