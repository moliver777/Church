...
# Settings
Setting.create({key: "site_title", value: "In Jesus' Steps"})
...
create_layout "PAGE", "4 - Corners Cross", '<div class="panel-wrapper corner home top left">@panel_1</div><div class="panel-wrapper corner home top right">@panel_2</div><div class="cross"><div class="cross-top"></div><div class="cross-left"></div><div class="cross-middle"></div><div class="cross-right"></div><div class="cross-bottom"></div></div><div class="panel-wrapper corner home middle left">@panel_3</div><div class="panel-wrapper corner home middle right">@panel_4</div><div class="clear"></div>', 4
...
home_page_layout = create_layout "PAGE", "1 - Full", '<div class="panel-wrapper full">@panel_1</div>', 1
create_layout "PAGE", "0 - Pre-Rendered"

create_layout "PANEL", "Corner Text", '<div id="@id" class="panel corner-text @classes">@text</div>'
...
home_panel_layout = create_layout "PANEL", "Full", '<div id="@id" class="panel full @classes">@text</div>'
