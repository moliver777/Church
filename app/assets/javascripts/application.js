...
function randomPrayer() {
    ...
    truth[1]='Dear Father, help me to always be aware of the marvels of my life now and not when I am in the depths of despire. AMEN'
    truth[2]='Walk beside me today, Lord, and show me the way to contentment and serenity. Amen'
    truth[3]= 'I thank You, Lord, for giving me so many people and so many opprtunities to love. Grant that I do not fail them. AMEN';
    ...
    truth[6]= 'Dear Lord, You are here , ever near, close to my heart. I cherish Thee and need Thee. Thank You for Your Care. Amen';
    truth[7]= 'Gracious Lord, You have given me hope and Your love for me has made me whole. Thank You for holding me up. Amen ';
    truth[8]= 'Lord, I know that ultimately time is all we have ~  help me to savor it not save it. Amen';
    truth[9]= 'Dear Father, when I center my life on You, my days are flooded with vitality. Thank You for Your tender mercies. Amen';
    truth[10]= 'Precious Lord, do not let me take this wonderful life for granted. I pause now to say a truth of thanks. Amen ';
    truth[11]= 'Father, I know I am too quick to see the faults in others. Help me to see my own faults just as clearly and instill in me the desire to shed my faults. Amen ';
    ...
    truth[17]= 'Lord, when my dreams are shattered, walk beside me, comfort me and show me the way to other dreams and fulfillment. Amen ';
    ...
    truth[21]= 'Dear Lord, help me to trust You so that I may feel You are with me always and therefore I need not fear. Amen.21';
    ...
    truth[23]= 'O Lord, mold me while I am silent, listening and calm, to be the person You planned for me to be. Amen';
    ...
    truth[26]='O Father, You enter my heart even when I am unaware of Your presence. Unbend me so that I will do Thy will with joy. Amen';
    truth[27]='Dear Lord, I know that pity will not feed the hungry, Prod me to help the hungry today with with food, both spiritual and physical. Amen';
    ...
    truth[35]='O GOD, I pray for the courage to embrace dreams, the strength to sacrifice for them, and the determination to fulfill them. Amen';
    ...
    truth[37]='Dear Lord, I ask forgiveness for not doing many things that I should have done, and for doing many things I did but should not have done. I\'m truely ashamed and real thankful that You are so forgiving. Amen ';
    ...
    truth[40]='Oh God, sometimes doubt seems to comsume me. help me not to make faith dependent upon the things I pray for and don\'t get. Amen';
    ...
    truth[44]='Father, help me to stop worrying about money. Instill in me the faith and confidence that You always provide. Amen';
    ...
    truth[49]='Dear Father, help me to remember that You are at work within me and around me each day, even when I am blind to thy good. Amen';
    ...
    truth[61]='I rely on You, Dear Lord, and my work becomes pleasant. I rely onYou and my burdens fall away. Amen  ';
    truth[62]='Dear Lord, teach me to trust You wherever I go, and wherever I go I shall do Your work. amen';
    truth[63]='Lord, should I feel sorry for myself today, help me to remember that no one lives in perfection and that tomorrow is a new untarished day. Amen ';
    truth[64]='Heavenly Lord, I know I have a mission that You have bestowed up just me. I pray that mission will be revealed to me so that I may do Your good works. Amen';
    ...
    truth[66]='Father, release me from wanting to straighten out everybody\'s affairs. I need toremember Iam not a judge. Amen';
    truth[67]='Father, I pray that my words and actions will not hurt anyone today. If I can not speak and act kindly, let me be silent. Amen';
    ...
    truth[71]='If I get discouraged today, Lord, let me feel Thy presence and guidance. As I extend my hand, let me feel Your reassuring touch and abundant love. Amen';
    ...
    truth[76]='Dear Lord, teach me that marvelous lesson that it is possible I may be mistaken occasionly. Amen';
    ...
    truth[80]='Merciful Lord, cleanse me from all the prejudices I harbor within me. Forgive me for all the injustices of my pride. Amen ';
    ...
    truth[87]='Dear Father, keeping  the promises I have made toYou. is my responsibility not Yours. Put me to work fulfilling those promises. Amen ';
    ...
    truth[91]='Lord, I know that You are everywhere and if I cry out and I cannnot find You it is because I have not completely opened my heart to You. Amen ';
    truth[92]='Father, I pray that You will help me not to be so self-centered. Fill me with the desire to think of others and to help them however Iam able. Amen ';
    ...
    truth[94]='Dear Lord. my heart clings to You. I know You are with me always and when You touch my soul, I am strengthen. Amen ';
    truth[95]='Dear Lord, help me to bridges, not walls and guide me accross those bridges to help someone in need. Amen';
